...
export default function ItemSearchInput({
  ...
  function updateSuggestions(inputValue) {
    ...
    const filteredIndex = hasActiveFilters
      ? applyFilters(itemsIndex || [])
      : itemsIndex || [];
    const candidateLimit = hasActiveFilters ? 80 : 10;
    const matches = findMatches(inputValue, filteredIndex, candidateLimit);
